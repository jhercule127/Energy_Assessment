...
CWater2 = read.csv(file = "C:/Users/alcir/OneDrive/Documents/R/Energy_Assessment/Chilledwater2018.csv")
...
CWater = read.csv(file = "C:/Users/alcir/OneDrive/Documents/R/Energy_Assessment/Chilledwater2019.csv")
...
electricity = read.csv(file = "C:/Users/alcir/OneDrive/Documents/R/Energy_Assessment/electricity by months 2018+2019.csv")
...
g5 + xlab("Month") + ylab("MMBTU") + theme_grey()
...
g6 + xlab("Month") + ylab("MMBTU") + theme_grey()
